...
class CustomLogOutBottomSheet extends StatelessWidget {
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetTitleText(text: AppStrings.logOut),
            ),
          ),
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetBodyText(text: AppStrings.sureLogOut),
            ),
          ),
          SliverPadding(
            padding: EdgeInsetsDirectional.only(
