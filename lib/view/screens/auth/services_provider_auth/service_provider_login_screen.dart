...
import 'package:medical_app/controller/auth_controllers/serviceprovider_controllers/service_provider_login_controller.dart';
...
class SPLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    SPLoginControllerImp loginController = Get.put(SPLoginControllerImp());
    return Scaffold(
