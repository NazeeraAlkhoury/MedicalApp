...
import 'package:medical_app/controller/auth_controllers/serviceprovider_controllers/service_provider_edits_controller.dart';
...
class ServicesProviderEditsScreen extends StatelessWidget {
  const ServicesProviderEditsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    SProviderEditsControllerImp controller =
        Get.put(SProviderEditsControllerImp());
    return Scaffold(
