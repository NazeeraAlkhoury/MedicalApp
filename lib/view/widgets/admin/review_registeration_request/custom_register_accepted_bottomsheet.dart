...
class CustomRegistrationAcceptedBottomSheet extends StatelessWidget {
  const CustomRegistrationAcceptedBottomSheet({
    Key? key,
  }) : super(key: key);
          ...
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetTitleText(
                  text: AppStrings.registRationAccepted),
            ),
          ),
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetBodyText(
                  text: AppStrings.sureRegistrationAccepted),
            ),
          ),
          SliverPadding(
            padding: EdgeInsetsDirectional.only(
