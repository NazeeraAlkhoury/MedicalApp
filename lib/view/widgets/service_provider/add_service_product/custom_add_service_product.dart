...
class CustomAddServiceProduct extends StatelessWidget {
  const CustomAddServiceProduct({super.key});

  @override
  Widget build(BuildContext context) {
    LayoutControllerImp layoutControllerImp = Get.find<LayoutControllerImp>();
              ...
              child: Column(
                children: [
                  ...
                  CustomAppButton(
                    ...
                    onPressed: () {
                      Get.back();
                      layoutControllerImp.changePage(8, 0);
                    },
                  )
                ],
              ),
