...
class CustomDeletePostBottomSheet extends StatelessWidget {
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetTitleText(text: AppStrings.deletePost),
            ),
          ),
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetBodyText(text: AppStrings.deleteSure),
            ),
          ),
          SliverPadding(
            padding: EdgeInsetsDirectional.only(
