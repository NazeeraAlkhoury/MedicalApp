...
class CustomEditPostBottomSheet extends StatelessWidget {
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetTitleText(text: AppStrings.editPost),
            ),
          ),
          SliverPadding(
            ...
            sliver: const SliverToBoxAdapter(
              child: CustomBottomSheetBodyText(text: AppStrings.editSure),
            ),
          ),
          SliverPadding(
            padding: EdgeInsetsDirectional.only(
